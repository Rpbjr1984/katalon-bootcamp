...
String index2_URL = WebUI.getUrl()

WebUI.verifyEqual(index2_URL, expectedIndex2URL)

WebUI.switchToWindowUrl(W3schoolWindowAlertURL)

WebUI.switchToWindowTitle(index1_URL)
