...
WebUI.verifyAlertPresent(GlobalVariable.ExplicitWaitTimeout)

WebUI.delay(GlobalVariable.SetWaitTime)

WebUI.setAlertText(userNamePrompt)

WebUI.delay(GlobalVariable.SetWaitTime)

WebUI.acceptAlert()

WebUI.verifyAlertNotPresent(GlobalVariable.SetWaitTime)
